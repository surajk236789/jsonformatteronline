            ...
            {output && (
              <div className="absolute top-3 right-3 flex items-center gap-2">
                ...
                <Button
                  ...
                  title="Download HTML"
                  className="p-2 bg-blue-600/90 hover:bg-blue-600 text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer shadow-md"
                >
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
