      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex flex-wrap justify-center p-1.5 bg-slate-200/60 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/60 rounded-2xl shadow-sm gap-1">
            ...
            >
              <span className={`w-2 h-2 rounded-full ${pathname === "/" ? "bg-emerald-500" : "bg-slate-400"}`}></span>
            ...
            >
              <span className={`w-2 h-2 rounded-full ${pathname === "/html-beautifier" ? "bg-blue-500" : "bg-slate-400"}`}></span>
            ...
            >
              <span className={`w-2 h-2 rounded-full ${pathname === "/base64-to-pdf" ? "bg-indigo-500" : "bg-slate-400"}`}></span>
            ...
            >
              <span className={`w-2 h-2 rounded-full ${pathname === "/json-compare" ? "bg-indigo-500" : "bg-slate-400"}`}></span>
