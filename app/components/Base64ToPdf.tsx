  ...
  return (
    <div className="w-full p-2 md:p-4 lg:p-6 rounded-2xl glass-panel shadow-lg border border-slate-200/40 dark:border-slate-800/40 transition-all duration-300">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        ...
        {!batchMode && (
          <button onClick={loadSample} id="load-sample-btn" className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-primary text-xs font-semibold rounded-lg transition cursor-pointer">
            📄 Load Sample
          </button>
        )}
        {batchMode && batchItems.length > 0 && (
          <>
            <button onClick={clearBatch} id="clear-batch-btn" className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-secondary text-xs font-semibold rounded-lg transition cursor-pointer">
              🗑 Clear All
            </button>
      ...
      {!batchMode && (
        <>
          ...
          <div className="flex flex-wrap items-center justify-end gap-3 mt-5 pt-5 border-t border-panel-border/50">
            <button onClick={handleClear} id="clear-btn" className="px-5 py-2.5 hover:bg-slate-100 dark:hover:bg-slate-800 text-secondary text-sm font-semibold rounded-lg transition cursor-pointer flex items-center gap-2">
