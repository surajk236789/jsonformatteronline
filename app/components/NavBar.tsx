...
export default function NavBar({ toolGroups, blogLinks }: NavBarProps) {
  ...
  useEffect(() => {
    function handleClick(e: MouseEvent) {
      ...
      if (blogsRef.current && !blogsRef.current.contains(e.target as Node)) setBlogsOpen(false);
    }
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-4 h-16 flex items-center justify-between">
        ...
        {/* Desktop nav */}
        <nav className="hidden md:flex items-center gap-1" ref={navRef} aria-label="Main navigation">
