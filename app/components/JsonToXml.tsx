      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            className="w-full h-80 md:h-[420px] p-4 font-mono text-sm border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all duration-200 shadow-inner resize-none"
        ...
        <div className="flex flex-col">
          ...
          <div className="relative w-full h-80 md:h-[420px] border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 overflow-hidden shadow-inner flex flex-col">
            {output ? (
