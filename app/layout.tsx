...
export const metadata: Metadata = {
  title: "Best Online JSON Formatter, HTML Beautifier & Base64 to PDF | Devloper Tools",
  ...
  authors: [{ name: "Devloper Tools Team" }],
  creator: "Devloper Tools",
  openGraph: {
    title: "Best Online JSON Formatter, HTML Beautifier & Base64 to PDF | Devloper Tools",
