...
const contentBlocks = [
  {
    ...
    body: "XML data returned by APIs or generated by systems is often minified into a single line to save space. Formatting XML adds proper indentation and line breaks, making the hierarchical node structure readable for humans."
  },
  {
    title: "How to Beautify XML",
    body: "Paste your raw XML string into the left editor. The tool parses the markup and outputs a beautifully indented, syntax-highlighted XML document on the right."
  }
];
